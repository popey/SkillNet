# ==========================================
# Procedure code template for WebShop environment
# ==========================================
def overall_procedure_code(
    ...
    """
    Procedure code template for solving a WebShop interactive task using iterative LLM-guided actions.
    ...
    while not task_done and current_steps < max_steps:
        ...
        # ============================================================
        observation, reward, task_done, info = env.step(action)
